...
import questionsGeneralKnowledge from "./data/general_knowledge.json";
import questionsAnimals from "./data/animals.json";
import questionsGeography from "./data/geography.json";
import questionsScience from "./data/science.json";
  ...
  const setCurrentCategory = (category) => {
    ...
    switch (category.name) {
      ...
      case CATEGORIES.history.name:
        ...
        break;
      case CATEGORIES.general_knowledge.name:
        setQuestions(questionsGeneralKnowledge);
        break;
      ...
      case CATEGORIES.geography.name:
        ...
        break;
      case CATEGORIES.science.name:
        setQuestions(questionsScience);
        break;
    ...
    <Container>
      <Row className="my-5">
        <Col className="text-center">
          <h1 onClick={() => setCategory(null)}>QUIZ BUZZ</h1>
        </Col>
      </Row>
      {category ? (
        <>
